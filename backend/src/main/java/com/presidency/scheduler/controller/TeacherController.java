...
public class TeacherController {
    ...
    public ResponseEntity<ApiResponse<List<TeacherResponse>>> getAll() {
        return ResponseEntity.ok(ApiResponse.ok(teacherService.getAll()));
    }
    ...
    public ResponseEntity<ApiResponse<TeacherResponse>> create(@Valid @RequestBody TeacherRequest req) {
        try {
            return ResponseEntity.ok(ApiResponse.ok("Teacher created", teacherService.create(req)));
        } catch (Exception e) {
    ...
    public ResponseEntity<ApiResponse<TeacherResponse>> update(@PathVariable Long id,
        ...
        try {
            return ResponseEntity.ok(ApiResponse.ok("Teacher updated", teacherService.update(id, req)));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
        }
    }
